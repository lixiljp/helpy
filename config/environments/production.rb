Rails.application.configure do
  ...
  # Log messages to stdout and flush immediately
  # For running in container environment such as AWS ECS which can't access local files easily
  STDOUT.sync = true
